...
extern const OSSL_DISPATCH
    oqs_smaug1_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_smaug1_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
...
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_smaug1_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_smaug1_decoder_functions[];


extern const OSSL_DISPATCH
    oqs_smaug3_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_smaug3_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
...
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_smaug3_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_smaug3_decoder_functions[];


extern const OSSL_DISPATCH
    oqs_smaug5_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_smaug5_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
...
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_smaug5_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_smaug5_decoder_functions[];


extern const OSSL_DISPATCH
    oqs_ntruplus_kem576_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem576_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem576_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem576_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem576_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem576_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_ntruplus_kem576_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_ntruplus_kem576_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_ntruplus_kem576_decoder_functions[];

extern const OSSL_DISPATCH
    oqs_ntruplus_kem768_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem768_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem768_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem768_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem768_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem768_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_ntruplus_kem768_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_ntruplus_kem768_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_ntruplus_kem768_decoder_functions[];


extern const OSSL_DISPATCH
    oqs_ntruplus_kem864_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem864_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem864_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem864_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem864_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem864_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_ntruplus_kem864_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_ntruplus_kem864_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_ntruplus_kem864_decoder_functions[];

extern const OSSL_DISPATCH
    oqs_ntruplus_kem1152_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem1152_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem1152_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem1152_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem1152_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_ntruplus_kem1152_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_ntruplus_kem1152_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_ntruplus_kem1152_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_ntruplus_kem1152_decoder_functions[];
...
extern const OSSL_DISPATCH
    oqs_haetae2_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_haetae2_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
...
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_haetae2_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_haetae2_decoder_functions[];

extern const OSSL_DISPATCH
    oqs_haetae3_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_haetae3_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
...
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_haetae3_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_haetae3_decoder_functions[];

extern const OSSL_DISPATCH
    oqs_haetae5_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_haetae5_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
...
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_haetae5_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_haetae5_decoder_functions[];    

extern const OSSL_DISPATCH
    oqs_aimer128f_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128f_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128f_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128f_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128f_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128f_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_aimer128f_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_aimer128f_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_aimer128f_decoder_functions[];    

extern const OSSL_DISPATCH
    oqs_aimer128s_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128s_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128s_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128s_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128s_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer128s_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_aimer128s_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_aimer128s_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_aimer128s_decoder_functions[];    

extern const OSSL_DISPATCH
    oqs_aimer192f_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192f_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192f_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192f_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192f_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192f_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_aimer192f_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_aimer192f_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_aimer192f_decoder_functions[];    

extern const OSSL_DISPATCH
    oqs_aimer192s_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192s_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192s_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192s_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192s_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer192s_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_aimer192s_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_aimer192s_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_aimer192s_decoder_functions[];    

extern const OSSL_DISPATCH
    oqs_aimer256f_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256f_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256f_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256f_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256f_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256f_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_aimer256f_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_aimer256f_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_aimer256f_decoder_functions[];    

extern const OSSL_DISPATCH
    oqs_aimer256s_to_PrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256s_to_PrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256s_to_EncryptedPrivateKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256s_to_EncryptedPrivateKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256s_to_SubjectPublicKeyInfo_der_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_aimer256s_to_SubjectPublicKeyInfo_pem_encoder_functions[];
extern const OSSL_DISPATCH oqs_aimer256s_to_text_encoder_functions[];
extern const OSSL_DISPATCH
    oqs_PrivateKeyInfo_der_to_aimer256s_decoder_functions[];
extern const OSSL_DISPATCH
    oqs_SubjectPublicKeyInfo_der_to_aimer256s_decoder_functions[];    
